...
export const MODEL_PROFILES: Record<string, Record<string, ModelProfile>> = {
  ...
  huggingface: {
    'smalllm-135m':  { contextWindow: 2_048,  maxInputTokens: 1_500,  maxOutputTokens: 512,   inputBudget: 1_200,  reportTemperature: 0.4, chatTemperature: 0.7 },
    'smalllm-1.7b':  { contextWindow: 4_096,  maxInputTokens: 3_000,  maxOutputTokens: 1_024, inputBudget: 2_400,  reportTemperature: 0.4, chatTemperature: 0.7 },
    'qwen-1.5b':     { contextWindow: 4_096,  maxInputTokens: 3_000,  maxOutputTokens: 1_024, inputBudget: 2_400,  reportTemperature: 0.4, chatTemperature: 0.7 },
